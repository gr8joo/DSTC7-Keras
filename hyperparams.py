class hyper_parameters:
    def __init__(self):
        ...
        self.vocab_path = 'data/ubuntu_uKB_test_lemma_vocab.txt'
        ...
        self.train_context_path = 'train_data/train_ubuntu_uKB_test/train_context.npy'#  'valid_data/valid_context.npy'#
        ...
        self.train_context_len_path = 'train_data/train_ubuntu_uKB_test/train_context_len.npy'# 'valid_data/valid_context_len.npy'#
        
        self.train_target_path = 'train_data/train_ubuntu/train_target.npy'# 'valid_data/valid_advising/valid_target.npy'#

        self.train_options_path = 'train_data/train_ubuntu_uKB_test/train_options.npy'# 'valid_data/valid_options.npy'#
        self.train_options_len_path = 'train_data/train_ubuntu_uKB_test/train_options_len.npy'# 'valid_data/valid_options_len.npy'#

        self.train_profile_path = 'train_data/train_ubuntu_uKB_test/train_profile.npy'
        ...
        self.valid_context_path = 'valid_data/valid_ubuntu_uKB_test/valid_context.npy'
        ...
        self.valid_context_mask_path = 'valid_data/valid_ubuntu_uKB_test/valid_context_mask.npy'
        ...
        self.valid_options_path = 'valid_data/valid_ubuntu_uKB_test/valid_options.npy'
        self.valid_options_len_path = 'valid_data/valid_ubuntu_uKB_test/valid_options_len.npy'

        self.valid_profile_path = 'valid_data/valid_ubuntu_uKB_test/valid_profile.npy'

...
if __name__ == "__main__":
    ...
    np.save(loc.train_context_len_path, context_len)
    np.save(loc.train_target_path, target)
    np.save(loc.train_options_path, options)
    np.save(loc.train_options_len_path, options_len)
    print("Done.")
    ...
    np.save(loc.valid_context_len_path, context_len)
    np.save(loc.valid_target_path, target)
    np.save(loc.valid_options_path, options)
    np.save(loc.valid_options_len_path, options_len)
    print("Done.")
